...
class Temperature {
  ...
  public:
     ...
     */
      ...
      static uint8_t fanSpeedPercent(const uint8_t fan)          { return pwm_to_percent(fan_speed[fan]); }
      static uint8_t scaledFanSpeedPercent(const uint8_t fan)    { return pwm_to_percent(scaledFanSpeed(fan)); }
